<script lang="ts">
	...
	import tuningByNick from "$lib/assets/projects/tuningbynick.png";
	import unity from "$lib/assets/projects/unity.jpg";
	import gameTracker from "$lib/assets/projects/tracker-1.jpg";
	...
	let projects: Project[] = [
		...
		},
		{
			...
			languages: "Vue.JS, C#, Electron, Python, AHK",
		},
		{
			title: "Discord Bot",
			date: "Apr 2019",
